  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:ring outline-0",
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        "border-2 border-gray-300 dark:border-gray-700 focus:border-gray-500 focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600 text-text",
        className
      )}
      {...props}
    />
